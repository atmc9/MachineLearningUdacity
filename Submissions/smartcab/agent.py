...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.training_no = 0
        self.init_state_value = dict()
        for a in self.valid_actions:
            self.init_state_value[a] = 0.0
    ...
    def createQ(self, state):
        ...
        if self.learning and state not in self.Q :
            self.Q[state] = self.init_state_value.copy()
    ...
    def choose_action(self, state):
        ...
        if not self.learning or self.epsilon > random.random():
            ...
            for state_action in self.Q[state]:
                if maxQValue == self.Q[state][state_action] :
                    maxActions.append(state_action)
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, epsilon=0.9, alpha=0.7)
